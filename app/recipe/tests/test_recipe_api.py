...
class PublicRecipeApiTests(TestCase):
    ...
    def test_auth_required(self):
        """ Test taht authenication is required """
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_retrieve_recipes(self):
        """ Test retrievingf a list of recipes """
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Lemongrass Soup')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Fried rice')
        recipe2 = sample_recipe(user=self.user, title='Potato soup')
